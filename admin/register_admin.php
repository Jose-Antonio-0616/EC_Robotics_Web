...
<body>
    ...
    <section class="form-container">
        ...
        <form action="" method="post">
            ...
            <input type="text" name="name" required placeholder="Ingrese nombre de usuario" maxlength="20" class="box"
                oninput="this.value = this.value.replace(/\s/g, '')">
            <input type="password" name="pass" required placeholder="Ingresar contraseña" maxlength="20" class="box"
                oninput="this.value = this.value.replace(/\s/g, '')">
