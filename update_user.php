...
<body>
    ...
    <section class="form-container">
        ...
        <form action="" method="post">
            ...
            <input type="text" name="name" required placeholder="Ingrese su nombre de usuario" maxlength="20"
            ...
            <input type="password" name="old_pass" placeholder="ingresa tu antigua contraseña" maxlength="20"
                class="box" oninput="this.value = this.value.replace(/\s/g, '')">
            <input type="password" name="new_pass" placeholder="Introduzca su nueva contraseña" maxlength="20"
                class="box" oninput="this.value = this.value.replace(/\s/g, '')">
            <input type="password" name="cpass" placeholder="Confirme la nueva contraseña" maxlength="20" class="box"
