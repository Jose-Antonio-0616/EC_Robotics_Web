    ...
    <section class="products shopping-cart">
        ...
        <div class="box-container">
            ...
            <form action="" method="post" class="box">
                ...
                <div class="flex">
                    <div class="price">Bs. <?= $fetch_cart['price']; ?>/-</div>
                ...
                <input type="submit" value="Eliminar elemento" onclick="return confirm('¿eliminar esto del carrito?');"
